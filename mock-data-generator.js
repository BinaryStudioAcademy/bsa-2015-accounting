...
_.times(categories.length, function(n) {
	...
	_.times(years, function(n) {
		...
		var budget = Factory.build('Budget', {year: startYear + n, category: {id: String(category._id), budget: budget_money}, subcategories: sub_with_money, creatorId: _.sample(managers, 1)[0]});
